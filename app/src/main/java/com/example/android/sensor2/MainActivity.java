...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        float[] rotationMatix = new float[9];
        boolean rotationOK = SensorManager.getRotationMatrix(rotationMatix, null, mAccelerometerData, mMagnetometerData);
        float orientationValues[] = new float[3];
        if (rotationOK) {
            SensorManager.getOrientation(rotationMatix, orientationValues);
        }
